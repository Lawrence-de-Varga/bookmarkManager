...
# base is a <dt> tag which will be used as a key 
# in the bookmarks dict. It's value is a list
...
# main_html is the structure of foldes and bookmarks
# which we operate on.
main_html: bs4.element.Tag = soup.dl.dl
...
# the file.
bmResultSet: bs4.element.ResultSet = main_html.find_all(['a', 'dt', 'dl'], recursive=False)
