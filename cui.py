...
class BookmarkManager:
    ...
    def __init__(self, master: py_cui.PyCUI):
        ...
        self.current_folder_contents = self.master.add_scroll_menu(f"EDITING: {title}", 0, 0, row_span=8, column_span=4)
        self.current_folder_contents.add_item_list(base_bms)
        self.selected_item_contents = self.master.add_scroll_menu(f"CONTENTS: {title}", 0, 4, row_span=8, column_span=4)
